...
### 2. API:
  ...
  *  [Postman environment](https://github.com/Alexfuz59/Training_Store_V2/blob/main/Postman_environment.json)
  *  [Swagger-файл REST API](https://github.com/Alexfuz59/Training_Store_V2/blob/main/Swagger_REST_API.yaml)
